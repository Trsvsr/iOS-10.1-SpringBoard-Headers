...
- (void)prepareToCrossfadeImageWithView:(id)arg1 crossfadeType:(unsigned long long)arg2 maskCorners:(_Bool)arg3 trueCrossfade:(_Bool)arg4 anchorPoint:(struct CGPoint)arg5;
- (void)prepareToCrossfadeImageWithView:(id)arg1 crossfadeType:(unsigned long long)arg2 maskCorners:(_Bool)arg3 trueCrossfade:(_Bool)arg4;
- (id)dropGlow;
- (void)removeDropGlow;
