...
- (_Bool)searchEtceteraViewController:(id)arg1 shouldDelaySearchWillDismissWithReason:(unsigned long long)arg2;
- (_Bool)searchEtceteraViewController:(id)arg1 shouldPresentSearchFromSource:(unsigned long long)arg2;
...
- (_Bool)_searchableTodayViewModeWantsBlur;
- (_Bool)_searchableTodayViewIsTransitioning;
- (_Bool)isSearchableTodayViewVisible;
...
- (struct UIEdgeInsets)_searchableTodayViewInsetsForPageControl;
...
- (_Bool)_isExternallyAnimatingDockOffscreenFraction;
