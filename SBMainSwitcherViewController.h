...
- (_Bool)_isTransitioningToOrFromSwitcher;
...
- (_Bool)_toggleSwitcherNoninteractivelyWithSource:(long long)arg1;
- (_Bool)toggleSwitcherNoninteractively;
- (_Bool)_dismissSwitcherNoninteractivelyWithSource:(long long)arg1;
- (_Bool)dismissSwitcherNoninteractively;
- (_Bool)_activateSwitcherNoninteractivelyWithSource:(long long)arg1;
